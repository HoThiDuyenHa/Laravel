...
                  <a href="detail/{{$sp->id}}"><img width="250" height="250" src="/source/image/product/{{$sp->image}}" alt=""></a>										
                </div>										
...
                <div class="single-item-caption">		
                  <a class="add-to-wishlist"><i class="fa fa-heart"></i></a>									
                ...
                @foreach($bestseller as $bl)
                    <div class="media beta-sales-item">
                        ...
                        <div class="media-body">
                            {{$bl->name }}
                            <span class="beta-sales-price">${{ number_format($bl->unit_price, 2) }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
