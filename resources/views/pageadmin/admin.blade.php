...
        <th scope="col">New</th>										
        <th scope="col"><a href='/admin-add-form' type="submit"  class="btn btn-primary" style="width:80px;">Add</a></th>										
      </tr>										
    </thead>										
    <tbody>										
...
        <th><img src="{{ asset('source/image/product/'.$product->image) }}" alt="{{ $product->name }}" width="200">
</th>										
        <td>{{$product->name}}</td>										
